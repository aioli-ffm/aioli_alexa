...
\section{Assits overview}
        \begin{frame}{List of some available assistants}
        	\centering
        	\begin{itemize}
        		\item Amazon Alexa {\includegraphics[width=.15\linewidth]{images/alexa_muted}}
        		
        		\item Google Home {\includegraphics[width=.15\linewidth]{images/ghome}}
